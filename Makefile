...
SRC_FILES       = $(wildcard src/*.c src/entity/*.c src/entity/entities/*.c src/game/*.c src/editor/*.c src/widgets/*.c src/util/*.c src/physics/*.c src/glutil/*.c src/graphics/*.c src/audio/*.c src/events/*.c src/map/*.c) 
